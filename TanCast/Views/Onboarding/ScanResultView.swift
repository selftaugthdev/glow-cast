    ...
    var body: some View {
        ZStack {
            ...
            VStack(spacing: 0) {
                ...
                Text(scanFailed ? "Pick Your Skin Type" : "Your Skin Profile")
                    .font(.system(size: 32, weight: .black))
                    .foregroundColor(.glowGold)
                    .opacity(appeared ? 1 : 0)

                Text(scanFailed
                     ? "The scan didn't get a clear read — choose the closest match"
                     : "AI estimate — adjust below if it's off")
                    .font(.system(size: 13))
